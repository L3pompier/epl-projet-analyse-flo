...
/* 
   VUE DASHBOARD — patch de renderDashboard
 */
const DashboardView = {
...
const StudentView = {
    ...
    _render(p) {
        ...
        /* Palmarès de la cohorte — réinitialiser la table à chaque étudiant
           pour rafraîchir le highlight "Vous" et la pagination proprement.
        ...
        try {
            if (this._type === 'ue') {
                /* /meta/ues retourne toutes les UEs (jusqu'à 5000).
                   getCompare avec liste vide est plafonné à 30 côté backend
